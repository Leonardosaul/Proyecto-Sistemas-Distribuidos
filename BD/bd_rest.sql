...
--
-- Servidor: localhost
-- Tiempo de generación: 19-10-2024 a las 18:47:19
...
CREATE TABLE `t_articulo` (
  `Id_Aritculo` varchar(10) NOT NULL,
...
INSERT INTO `t_producto` (`Id_Prod`, `Id_Articulo`, `Descripcion`, `costo`, `precio`, `cantidad`) VALUES
...
ALTER TABLE `t_producto`
  ADD PRIMARY KEY (`Id_Prod`,`Id_Articulo`) USING BTREE,
